...
export default function Navbar() {
    ...
    return (
        <div className="flex flex-col w-full sticky top-0 z-50">
            ...
            <div className="w-full bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 text-white text-xs sm:text-sm font-semibold py-2 px-4 flex justify-center items-center">
                <span>Free shipping on all orders above ₹1000! 🚚 <Link to="/products" className="underline ml-2 hover:text-pink-200">Shop Now</Link></span>
            </div>
            <nav className="w-full backdrop-blur-lg bg-white/70 dark:bg-slate-950/70 border-b border-slate-200 dark:border-slate-800 transition-colors">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden md:flex ml-10 space-x-8">
                            ...
                            <Link to="/products?category=religious" className="text-slate-700 dark:text-slate-300 hover:text-pink-500 dark:hover:text-pink-400 font-medium transition-colors">Religious</Link>
                    ...
                    {isMobileOpen && (
                        ...
                        >
                            <div className="px-4 pt-2 pb-6 space-y-1">
                                ...
                                <Link onClick={() => setIsMobileOpen(false)} to="/products?category=religious" className="block px-3 py-3 rounded-md text-base font-medium text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800">Religious Dresses</Link>
